          ...
          <div className="row">
            ...
            <div className="col-md-7 d-flex flex-column justify-content-center">
              <div className="text-animated">
                ...
                <p className="text-white fw-light mb-4 col-12">
                  Cloudstry Technologies drives your digital transformation with
                  cutting-edge product solutions, bridging critical industry
                  gaps. Our scalable platforms and AI-powered tools streamline
                  operations, ensuring efficiency, agility, and a competitive
                  edge in today’s fast-paced landscape.
                </p>
                <p className="mb-4 col-12 text-white">
                  With deep expertise and innovation at the core, Cloudstry
                  Technologies empowers industry leaders with robust,
                  mission-critical solutions designed for seamless growth and
                    ...
                    {productCarouselData.map((data, index) => (
                      <Link to={data.link}>
                        <div className="highlight-card p-4" key={index}>
                          <h5 className="card-title fw-light mb-2">
                            {data.title}
                          </h5>
                          <p>
                            {data.desc}
